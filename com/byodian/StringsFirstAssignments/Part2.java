...
public class Part2 {
  ...
  public static String getOptionalParameter(String codon, String defaultCodon) {
    Optional<String> optionalCodon = Optional.ofNullable(codon);
    String optionalParameter = optionalCodon.isPresent() ? optionalCodon.get() : defaultCodon;
  ...
  public static String findSimpleGene2(String dna, String startCodon, String stopCodon) {
    ...
    String startCodonParameter = getOptionalParameter(startCodon, "ATG").toLowerCase();
    int startIndex = lowerCaseDna.indexOf(startCodonParameter);
    if (startIndex == -1) { return ""; }

    String stopCodonParameter = getOptionalParameter(stopCodon, "TAA").toLowerCase();
